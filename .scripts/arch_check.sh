...
# ---------------------------------------------------------------- INV4
# Harness turns only through the configured Adapter. Concrete transports are
# implementation details of their adapter.
EXCLUDE='^lib/omashiki/harness/(open_code(_http)?|claude_code)\.ex'
scan ENGINE_DIRECT \
