...
| NFR-005 | Reject protected paths, symlinks, and oversized changes before publication, hold output with secrets found by gitleaks for review or reject it as the environment declares, and refuse output when the scan cannot run. |
